...
exports.printOrderDetails = void 0;
const getPackDetails = (productCode) => {
    const products = {
        "VS5": [
            { size: 3, price: 6.99 },
            { size: 5, price: 8.99 }
...
const printOrderDetails = (quantity, productCode) => {
